...
const ProblemList = ({ user, room, problems, selected,handleProblemClicked, handleProblemSelect }) => {
    return (
        <div className="problem-section">
            {problems.map((problem) => (
                <div key={problem._id} className="problem"
                    ...
                    {room.created_by === user.id && <div><button onClick={()=>handleProblemSelect(problem._id)}>
